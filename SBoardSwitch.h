...
#ifndef SBOARDSWITCH_H_
#define SBOARDSWITCH_H_

#include "SBoardTile.h"

class SBoardSwitch : public SBoardTile
{
	Q_OBJECT
	
public:
	SBoardSwitch(enum BOARD_MODE, int f_layerID, int f_gameboardID);
	virtual void SpecialInitByXML(SXMLParse f_xmlparse);
	virtual ~SBoardSwitch();
...
protected:
	...
	bool m_switchState; // false: Weiche gerade; true: Weiche als Kurve
	bool m_switchable;
};
